		...
		try {
			...
			stage.setOnCloseRequest(new EventHandler<WindowEvent>() {
				...
				public void handle(WindowEvent event) {
					AppPreferences.setPreference(AppPreferences.WINDOW_CREDITS_PREFERENCES, new Window_Preferences(stage).toJson());
					stage.hide();
				}
			});

			String preferencesJson = AppPreferences.getPreference(AppPreferences.WINDOW_CREDITS_PREFERENCES, null);
